...
from wtforms import IntegerField, StringField, SubmitField, TextAreaField, PasswordField
...
class MovieForm(FlaskForm):
    ...
    year = IntegerField("Year", validators=[InputRequired(), NumberRange(min=1960, message="Please enter a year in the format YYYY.")])
